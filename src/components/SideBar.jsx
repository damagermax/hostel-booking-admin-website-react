...
import { BiUser, BiSignal4 } from "react-icons/bi";
  ...
  return (
    <div className="my-10 ">
      <div className="flex gap-2 items-center ">
        <img src={url} alt="" className="w-[40px] h-[40px]  rounded-full" />

        <div className="text-[0.75rem] leading-4 text-gray-700">
          <p>Maxwell Takyi</p>
          <p className="text-gray-500">maxwelltakyi@gmail</p>
        </div>
      </div>
    </div>
  );
...
const SideBar = () => {
  return (
    <aside className="w-[280px] hidden lg:block">
      <div className=" border min-h-full h-screen bg-gray-100 p-4 text-[0.85rem] font-medium">
        <DiCoda size={30} className="text-blue-600" />

        <Account />

        <div className="grid gap-[6px] text-gray-700">
          <NavLink
            to="/analytics"
            className={(isActive) => {
              return (
                "w-full px-3 py-2 flex items-center gap-2 rounded-md  " +
                (isActive.isActive ? "  bg-gray-200" : " bg-gray-100 ")
              );
            }}
          >
            <BiSignal4 size={23} className=" text-gray-400" />
            <p>Analytics</p>
          </NavLink>
          ...
          >
            <MdOutlineBedroomParent size={23} className=" text-gray-400" />
            <p>Rooms</p>
          </NavLink>
          ...
          >
            <HiOutlineDocumentText size={23} className=" text-gray-400" />
            <p>Bookings</p>
          </NavLink>
          ...
          >
            <BiUser size={23} className=" text-gray-400" />
            <p>Users</p>
          </NavLink>
        </div>
      </div>
